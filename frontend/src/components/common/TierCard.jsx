...
export function TierCard({ tier, label, accessible, teaser, includedTopics, active, onOpen }) {
  return (
    <Card
      className={cn(
    ...
    >
      <CardContent className="space-y-5 p-6">
        ...
        <p className="text-sm leading-7 text-slate-300" data-testid={`tier-card-${tier}-teaser`}>{teaser}</p>
